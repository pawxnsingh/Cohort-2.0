...
For this one, in every authenticated requests, you need to send the jwt in headers (Authorization : "Bearer <actual token>"). and little addon try to store that token in local storage
